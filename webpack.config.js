...
module.exports = {
  ...
  plugins: [
    new FaviconsWebpackPlugin('./src/assets/img/normalBall.svg'), // svg works too!
...
//npm outdated revisar dependencias a actualizar
//npm update actualización

//npx npm-check-updates -u nuevas evrsiones
//npm install instalar esas versiones
